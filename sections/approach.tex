...
we use Basis Technology's Rosette Linguistics Platform (RLP) suite of multilingual commercial tools (\url{http://www.basistech.com/text-analytics/rosette/})\narenc{give URL}
for this stage.
...
%\begin{figure*}
%    \includegraphics[width=\textwidth]{enrichment}
