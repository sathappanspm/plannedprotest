...
reverse geocoded into place names. We make use of a KD-Tree build using
World Gazetteer data for this purpose.Second, we consider Twitter places
...
We use a highly specific list of 15 keywords and their variants in the three languages English, Spanish, Portuguese to query the Facebook Graph Api for Events.The Facebook Graph Api returns a list of Event-IDs, which is then used in an FQL query to get all available details of that event from Event table.
