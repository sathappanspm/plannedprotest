...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{monthlyqs}
  \vspace{-0.5em}
...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{venezuela}
  \vspace{-0.5em}
...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{brazil_june}
  \vspace{-0.5em}
...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{leadTimeVsQS}
  \vspace{-0.5em}
...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{matchingwindow}
  \vspace{-0.5em}
...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{doubleHump}
  \vspace{-1em}
