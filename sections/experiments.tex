...
metrics similar to those described in Ramakrishnan et al.~\shortcite{emberskdd}.
...
Table~\ref{tb:sourcewisecomparison} presents a breakdown of performance, country-wise and source-wise, of 
...
A longitudinal perspective on quality scores is
...
of spontaneity to the Brazilian protests; they arose as discontent about bus fare increases but later morphed into a broader
...
Fig.~\ref{fig:matchinginterval} shows the performance of the model when the matching window is varied from 7 to 1 in steps. 
