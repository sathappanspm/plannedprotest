...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.5\linewidth]{monthlyqs}
  \vspace{-0.5em}
...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.5\linewidth]{venezuela}
  \vspace{-0.5em}
...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.5\linewidth]{brazil_june}
  \vspace{-0.5em}
...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.5\linewidth]{leadTimeVsQS}
  \vspace{-0.5em}
...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.5\linewidth]{matchingwindow}
  \vspace{-0.5em}
...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[width=0.5\linewidth]{doubleHump}
  \vspace{-1em}
