...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[scale=0.5]{gsr_distribution} 
  \vspace{-1em}
...
\begin{subfigure}{\columnwidth}
  \centering
  \includegraphics[scale=0.5]{pp_dist}
  \vspace{-1em}
...
\begin{figure*}
  \begin{subfigure}{\columnwidth}
    \centering
    \includegraphics[scale=0.3]{venezuela}
    \caption{Venezuelan protests}
    \label{fig:venezuela_feb}
\end{subfigure}
\begin{subfigure}{\columnwidth}
    \centering
    \includegraphics[scale=0.3]{brazil_june}
...
\begin{figure}[h!]
    \centering
  \includegraphics[scale=0.4]{doubleHump}
