...
It is natural to assume that a larger protest will be more disruptive and garner attention ore effectively a smaller protest. 
Mobilizing large numbers of people to protest together involves significant planning activity, with the date, time and place announced in
advance and so we might expect that a large number of protests would be plannedand announced in advance. Indeed we found planned protests to be the norm. In a sample of 288 protest events selected for a qualitative study of the apparent antecedednts to the event, fully 225 were found to be planned, meaning we located communications regarding the upcoming occurrence of the event in media. Only 49 could be clearly classified as spontaneous (we could not determine whether communications had or had not occurred in the remaining 14 cases).

Our hypothesis, then, is that a system for identifying event-planning communications will be able to contribute significantly to a system for predicting upcoming civil-unrest events.
...
Finally, identifying the date of a planned event in Latin America involves significant milti-lingual temporal-semantic natural language processing as dates are often described with vague or context-dependent expressions (e.g., {\em Sunday} or {\em in two days}).
