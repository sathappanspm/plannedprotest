...
In this section, we briefly describe Probabilistic Soft Logic(PSL) \cite{kimmig2012short} which is used to geo-code news/blogs as given in ~\ref{subsection:geocoding}.
