...
Radinsky and Horvitz~\shortcite{Radinsky:2013:MWP} find event sequences from a corpora and then use these sequences to determine if 
...
Kallus~\shortcite{nathankallus} makes use of event data from 
...
{\bf Future retrieval:}
Baeza-Yates~\shortcite{baeza2005searching} provides one of the earliest discussions
...
Kawai et al.~\shortcite{Kawai:2010:CSE} present a search engine (ChronoSeeker) for searching 
...
Two publications---Compton et al.~\shortcite{compton2013detecting} and Xu et al.~\shortcite{xu2014civil}---align very closely to our own work as their emphasis is on protest forecasting.
