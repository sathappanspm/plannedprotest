...
\begin{table*}
    ...
    \begin{tabular}{l c c c c c }
        ...
        \hline
        Future Search Engines~\cite{Kawai:2010:CSE, bosch2013estm, Jatowt:2011:ECE, tops2013predicting}&\checkmark & & &\\
        Time-to-Event Recognition&&&&\\
        Early Planned Protest Detection ~\cite{xu2014civil,compton2013detecting} & &\checkmark& & \checkmark\\
